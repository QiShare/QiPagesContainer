...
#pragma mark - QiPagesContainerDataSource
...
#pragma mark - QiPagesContainerDelegate
...
//    _titleArr = [NSArray arrayWithObjects:@"001", @"0002", @"000004", @"0005",  @"0006", @"0007", @"000008", nil];
    _titleArr = [NSArray arrayWithObjects:@"001", @"0002", @"3", nil];
    NSMutableArray *tempTableViews = [NSMutableArray array];
    for (int i=0; i<[_titleArr count]; i++) {
        UIColor *randomColor = [UIColor colorWithRed:arc4random()%255/255.0 green:arc4random()%255/255.0 blue:arc4random()%255/255.0 alpha:0.3];
        UIView *subView = [[UIView alloc] initWithFrame:CGRectZero];
